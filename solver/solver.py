...
class SimplexFEM2:
	...
	def stiffness_matrix_as_blocks(self):
		...
		blocks = [
			[stiffness[ 0:3,0:3], stiffness[ 0:3,3:6], stiffness[ 0:3,6:9]],
			[stiffness[ 3:6,0:3], stiffness[ 3:6,3:6], stiffness[ 3:6,6:9]],
			[stiffness[ 6:9,0:3], stiffness[ 6:9,3:6], stiffness[ 6:9,6:9]],
		]
		return blocks
